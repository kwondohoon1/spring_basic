...
//    Entity의 생명주기를 관리. 데이터베이스와의 모든 상호작용을 책임진다.
...
//        persist : 전달된 엔티티(Member)가 엔티티매니저의 관리상태가 되도록 만들어주고,
//        트랙젝션이 커밋될 때 데이터베이스에 저장 insert
...
//        jpql : jpa 의 쿼리문법
//        장점 : DB에 따라 문법이 달라지지 않는 객체지향언어, 컴파일타임에서 체크 SpringDataJpa의 @Query 기능
